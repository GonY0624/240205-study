...
public class Application02 {
    ...
    public static void main(String[] args) {
        ...
        /* 목차. 3. 메인 메소드 시작을 확인하기 위한 출력구문을 작성한다.  */
    ...
    public void methodB(){
        ...
        System.out.println("methodB() 시~작~시~작~");
        System.out.println("methodB() 끝~ 끝~");

    }

    public void methodC(){

        System.out.println("methodC() 시~작~시~작~시~작~");
        System.out.println("methodC() 끝~끝~끝~");
