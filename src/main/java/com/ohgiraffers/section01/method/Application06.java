...
public class Application06 {
    ...
    public static void main(String[] args) {
        ...
        /* 필기.
        *   메소드 리턴값 테스트
        *   메소드 항상 마지막에 return 명령어가 존재한다.
        *   return 은 자신을 호출한 구문으로 복귀하는 것을 의미한다.
        *   복귀를 할 떄 그냥 복귀를 할 수 도 있지만, 값을 가지고 복귀할 수 있다.
        ...
        *  */
        ...
        Application06 app06 = new Application06();
        String hi = app06.testMethod1();
        ...
        System.out.println(app06.testMethod1());
