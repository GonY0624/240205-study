...
public class Application01 {
    ...
    public static void main(String[] args) {
        ...
        /* 수업목표. java.until.Scanner 를 이용한 다양한 자료형 값 받아오기 */
...
//        java.util.Scanner sc = new java.util.Scanner(System.in);
        ...
        /* 목차. 1-2. 다른 패키지에 있는 클래스 사용 시 패키지명을 생략하기 위해 inport 를 사용.  */
        ...
        /* 목차. 2-1. 정수형 값 입력받기. */
        /* 필기. nextInt() : 입력받을 값을 int 형으로 반환해줌 */
        System.out.print("나이를 입력해주세요 : ");
        int age = sc.nextInt();
        System.out.println("입력하신 나이는 " + age + " 입니다. ");

        /* 필기. nextLong() : 입력 받은 값을 long 형으로 반환한다.저  */
        ...
        System.out.print("참과 거짓 중 한 가지를 true / false 로 입력해주세요 :  " );
        boolean isTrue = sc.nextBoolean();
        System.out.println("결과는 " + isTrue + "입니다. ");

        /* 목차. 2-5. 문자형 값 입력받기 .  */
        sc.nextLine();
        System.out.println("아무 문자나 입력해주세요 : " );
        char ch = sc.nextLine().charAt(0);
        System.out.println("아무문자나 입력한 값은 : " +ch + " 입니다. ");
